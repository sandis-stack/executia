...
export default async function handler(req, res) {
  ...
  try {
    ...
    const fromAddress = "EXECUTIA <system@mail.executia.io>";
    const replyTo = "control@executia.io";
    ...
    const internalResult = await sendViaResend({ apiKey, from: fromAddress, to: ["control@executia.io"], subject: internalSubject, text: internalText, replyTo });
